...
?>
<div class="<?php echo esc_attr( $mycoach_container ); ?> cont-padding page-layout-<?php echo esc_attr( $mycoach_blog_layout ); ?> blog-<?php echo esc_attr( $mycoach_blog_class ); ?>">
	<div class="row">
