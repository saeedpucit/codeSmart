...
class NETBEEFramework_Shortcodes_API extends NETBEEFramework_Abstract {
	...
	public function __construct( $args = array() ) {
		...
		$this->mycoach_add_action( 'media_buttons', 'media_shortcode_button', 99 );
		$this->mycoach_add_action( 'admin_footer', 'shortcode_dialog', 99 );
		$this->mycoach_add_action( 'wp_ajax_get-shortcode', 'shortcode_generator', 99 );
	}
	/**
	 *
	...
	public function shortcode_generator() {
		...
		foreach ( $shortcode_atts as $key => $field ) {
			...
			$this->mycoach_add_element( $field, $field_default, 'shortcode' );
		}
