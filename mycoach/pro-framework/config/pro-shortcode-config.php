 ...
 *
 */
$mycoach_animation_names = mycoach_get_animations();
$mycoach_animations      = array();
foreach ($mycoach_animation_names as $key => $value) {
  $mycoach_animations[$value] = $value;
}
// Animation
// ------------------------------------------------------------------------------------------
$mycoach_map_animation          = array(
  'id'                     => 'animation',
  'type'                   => 'select',
  'title'                  => 'Animation',
  'options'                => $mycoach_animations,
);
$mycoach_map_animation_delay    = array(
  'id'                     => 'animation_delay',
  'type'                   => 'text',
...
$mycoach_map_animation_duration = array(
...
// Extras
// ------------------------------------------------------------------------------------------
$mycoach_map_id                 = array(
  'id'                     => 'id',
  'type'                   => 'text',
  'title'                  => 'ID <em>(Optional)</em>',
);
$mycoach_map_class              = array(
  'id'                     => 'class',
  'type'                   => 'text',
  'title'                  => 'Class <em>(Optional)</em>',
);
$mycoach_map_style              = array(
  'id'                     => 'in_style',
  'type'                   => 'text',
  'title'                  => 'Inline Style <em>(Optional)</em>',
);
$mycoach_map_content            = array(
  'id'                     => 'content',
  'type'                   => 'textarea',
  'title'                  => 'Content',
);
$mycoach_shortcodes                   = array(
  'helpers'                      => array(
    'title'                      => 'Quick Helpers',
    'shortcodes'                 => array(
      //                         ==========================================
      ...
      'mycoach_alert'                 => array(
        ...
        'shortcode_atts'         => array(
          ...
          $mycoach_map_animation,
          $mycoach_map_animation_delay,
          $mycoach_map_animation_duration,
          $mycoach_map_content,
        ),
      ),
      //                         ==========================================
      ...
      //                         ==========================================
      'mycoach_responsive_image'      => array(
        ...
        'shortcode_atts'         => array(
          ...
          array(
            ...
            'type'               => 'select',
            'title'              => 'Image Size',
            'options'            => array_flip( mycoach_get_image_sizes( true ) ),
            'default'            => 'full',
          ),
          array(
            'id'                 => 'alignment',
      ...
      // RESPONSIVE VIDEO
      //                         ==========================================
      'mycoach_responsive_video'      => array(
  ...
  'useful'                       => array(
    ...
    'shortcodes'                 => array(
      ...
      // BUTTON GROUP
      //                         ==========================================
      'mycoach_button_group'          => array(
        'title'                  => 'Button Group',
        'shortcode_atts'         => array( $mycoach_map_content ),
      ),
    ),
  ),
  'infographics'                 => array(
  ...
  'lists'                        => array(
    ...
    'shortcodes'                 => array(
      ...
      // ICON LIST
      //                         ==========================================
      'mycoach_icon_list'             => array(
        'title'                  => 'Icon List',
        'view'                   => 'flexible',
        'clone_id'               => 'mycoach_icon_list_item',
      ...
      // CLIENT LIST
      //                         ==========================================
      'mycoach_clients'               => array(
        'title'                  => 'Clients List',
        'view'                   => 'flexible',
        'clone_id'               => 'mycoach_client',
        'clone_title'            => 'Add New List Item',
        'shortcode_atts'         => array(
          array(
            'id'                 => 'columns',
      ...
      // TESTIMONIAL SLIDER
      //                         ==========================================
      'mycoach_testimonials'          => array(
        'title'                  => 'Testimonials',
        'view'                   => 'flexible',
        'clone_id'               => 'mycoach_testimonial',
...
[vc_toggle title                 ="Question"]Answer[/vc_toggle]'
  ...
  'tables'                       => array(
    ...
    'shortcodes'                 => array(
      ...
      // PRICING TABLE
      //                         ==========================================
      'mycoach_pricing_table'         => array(
        'title'                  => 'Pricing Table',
        'view'                   => 'flexible',
        'clone_id'               => 'mycoach_pricing_column',
...
40.7060000|-74.0060000|Route Ltd #2',
      ...
      // CAROUSEL CONTENTS
      //                         ==========================================
      'mycoach_carousel'              => array(
        'title'                  => 'Carousel Contents',
        'view'                   => 'flexible',
        'clone_id'               => 'mycoach_carousel_item',
...
new NETBEEFramework_Shortcodes_API( $mycoach_shortcodes );